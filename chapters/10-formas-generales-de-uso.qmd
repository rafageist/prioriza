...
los elementos, se nivelan los aspectos, se aplican pesos y se obtiene
...
- usar el resultado de una tabla para definir pesos de aspectos;
...
una única tabla enorme. También permite justificar pesos, calcular
...
detectar aspectos faltantes, justificar pesos o auditar decisiones.
...
## Uso del resultado como peso de aspectos
...
priorizar los propios aspectos de otra tabla.
    ...
    Resultado RX = pesos derivados.
    Tabla Y usa RX como vector de pesos.

Esto permite justificar pesos que, de otro modo, serían asignados
